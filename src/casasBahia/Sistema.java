...
import excecoes.NumerosIndevidosException;
import excecoes.OpcaoInexistenteException;
import excecoes.PrecoInvalidoException;
import excecoes.ValorNuloException;
...
public class Sistema {
	...
	public void adicionarProduto(Scanner scanner) throws PrecoInvalidoException, NumerosIndevidosException, OpcaoInexistenteException {
		System.out.println("Digite o nome do produto: ");
		String nome = scanner.nextLine();
		if (!(nome.matches(".*[a-zA-Z].*"))){
			throw new NumerosIndevidosException("Digite um nome válido, por extenso!");
		}
		...
		scanner.nextLine();
		if (opcao < 1 | opcao > 2){
			throw new OpcaoInexistenteException("Esta opção está fora das oferecidas");
		}
		if (opcao == 1) {
			try {
	...
	private void adicionarMovel(Scanner scanner, String nome, String codigo, double preco) throws ValorNuloException{
		System.out.println("Digite o material:");
		String material = scanner.nextLine();
		if (material == null){
			throw new ValorNuloException("Por favor, preencha o campo!");
		}
